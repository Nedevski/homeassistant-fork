...
from homeassistant.components.kat_bulgaria.const import PersonType
...
# region KatClient mocks


@pytest.fixture(name="client_ok_individual")
def mock_client_ok_individual(
...
@pytest.fixture(name="client_ok_business")
def mock_client_ok_business(
    hass: HomeAssistant, request: pytest.FixtureRequest
) -> MagicMock:
    """Fixture to mock KatClient."""
...
@pytest.fixture(name="client_fine_served_individual")
def mock_client_fine_served_individual(
...
@pytest.fixture(name="client_fine_served_business")
def mock_client_fine_served_business(
    hass: HomeAssistant, request: pytest.FixtureRequest, ok_fine_served: pytest.fixture
) -> MagicMock:
    """Fixture to mock KatClient."""
...
@pytest.fixture(name="client_api_timeout_individual")
def mock_client_api_timeout_individual(
    hass: HomeAssistant, request: pytest.FixtureRequest
) -> MagicMock:
    """Fixture to mock KatClient."""
...
@pytest.fixture(name="client_api_timeout_business")
def mock_client_api_timeout_business(
    hass: HomeAssistant, request: pytest.FixtureRequest
) -> MagicMock:
    """Fixture to mock KatClient."""
